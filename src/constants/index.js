...
const experiences = [
  {
    ...
    company_name: "Delta Clause",
    icon: starbucks,
    iconBg: "#E6DEDD",
    date: "1 Jan 2024 -  28 Feb 2024",
    points: [
      "Developing and maintaining web applications using React.js and other related technologies.",
      "Collaborating with teams members including designers, and other developers to create high-quality products.",
